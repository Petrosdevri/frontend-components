...
const toolTipTail = document.createEleemnt("div");
toolTipTail.classList.add("tooltip-tail");

document.onmousedown = () => {
    const selectedText = window.getSelection();
    const anchorNode = selectedText.anchorNode;
    ...
    const rangeRect = selectedText.getRangeAt(0).getClientRects()[0];
